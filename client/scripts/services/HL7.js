  ...
  return {
    ...
    convertToModels: function(records) {
      ...
      for (var i = 0; i < records.length; i++) {
        ...
        model.hdlCholesterol = {
          value: segments[0].fields[5].value[0][0].value[0][0],
          units: segments[0].fields[5].value[0][1].value[0][0]
        };
        model.triglycerides = {
          value: segments[1].fields[5].value[0][0].value[0][0],
          units: segments[1].fields[5].value[0][1].value[0][0] 
        };
        model.vldl = {
          value: segments[2].fields[5].value[0][0].value[0][0],
          units: segments[2].fields[5].value[0][1].value[0][0]
        };
        model.ldl = {
          value: segments[3].fields[5].value[0][0].value[0][0],
          units: segments[3].fields[5].value[0][1].value[0][0]
        };
        model.cholesterol = {
          value: segments[4].fields[5].value[0][0].value[0][0],
          units: segments[4].fields[5].value[0][1].value[0][0]
        };
